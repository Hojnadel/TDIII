...
;*************************************************************************************;
GLOBAL	page_memory_task2
page_memory_task2:
; Limpio el Directorio y las Tablas de paginación
EXTERN  __PAGE_DIRECTORY_ADDR_TASK2
EXTERN  __PAGE_TABLE_0x000_TASK2_ADDR
EXTERN  __PAGE_TABLE_0x001_TASK2_ADDR
EXTERN  __PAGE_TABLE_0x07F_TASK2_ADDR
EXTERN  __PAGE_TABLE_0x3FF_TASK2_ADDR
EXTERN  __PAGE_TABLES_SIZE
    mov edi, __PAGE_DIRECTORY_ADDR_TASK2
...
EXTERN  __INIT_PHYSICAL_ADDR
    push __PAGE_DIRECTORY_ADDR_TASK2
    push __PAGE_TABLE_0x3FF_TASK2_ADDR
...
EXTERN  __ISR_LEN
    push __PAGE_DIRECTORY_ADDR_TASK2
    push __PAGE_TABLE_0x000_TASK2_ADDR
...
EXTERN  __KERNEL_LEN
    push __PAGE_DIRECTORY_ADDR_TASK2
    push __PAGE_TABLE_0x001_TASK2_ADDR
...
EXTERN  __TASK2_TEXT_PHYSICAL_ADDR
EXTERN  __TASK2_TEXT_LEN
    push __PAGE_DIRECTORY_ADDR_TASK2
    push __PAGE_TABLE_0x001_TASK2_ADDR
    push __TASK2_TEXT_LINEAR_ADDR
    push __TASK2_TEXT_PHYSICAL_ADDR
...
EXTERN  __TASK2_BSS_LINEAR_ADDR
EXTERN  __TASK2_BSS_PHYSICAL_ADDR
EXTERN  __TASK2_BSS_LEN
    push __PAGE_DIRECTORY_ADDR_TASK2
    push __PAGE_TABLE_0x001_TASK2_ADDR
    push __TASK2_BSS_LINEAR_ADDR
    push __TASK2_BSS_PHYSICAL_ADDR
...
;Tamaño de la sección: 0x9 Bytes ==> 1 página
EXTERN  __TASK2_DATA_LINEAR_ADDR
EXTERN  __TASK2_DATA_PHYSICAL_ADDR
EXTERN  __TASK2_DATA_LEN
    push __PAGE_DIRECTORY_ADDR_TASK2
    push __PAGE_TABLE_0x001_TASK2_ADDR
    push __TASK2_DATA_LINEAR_ADDR
    push __TASK2_DATA_PHYSICAL_ADDR
...
EXTERN  __KERNEL_STACK_SIZE
    push __PAGE_DIRECTORY_ADDR_TASK2
    push __PAGE_TABLE_0x07F_TASK2_ADDR
...
;Paginación de TASK2_KERNEL_STACK
;Dirección física: 0x1FFF9000
...
EXTERN  __TASK2_KERNEL_STACK_LINEAR_ADDR
EXTERN  __TASK2_KERNEL_STACK_PHYSICAL_ADDR
EXTERN  __TASK2_KERNEL_STACK_SIZE
    push __PAGE_DIRECTORY_ADDR_TASK2
    push __PAGE_TABLE_0x001_TASK2_ADDR
    push __TASK2_KERNEL_STACK_LINEAR_ADDR
    push __TASK2_KERNEL_STACK_PHYSICAL_ADDR
...
;Paginación de TASK2_USER_STACK
;Dirección física: 0x1FFFD000
...
;Tamaño de la sección: 0x1000 Bytes ==> 1 página
EXTERN  __TASK2_USER_STACK_LINEAR_ADDR
EXTERN  __TASK2_USER_STACK_PHYSICAL_ADDR
EXTERN  __TASK2_USER_STACK_SIZE
    push __PAGE_DIRECTORY_ADDR_TASK2
    push __PAGE_TABLE_0x001_TASK2_ADDR
    push __TASK2_USER_STACK_LINEAR_ADDR
    push __TASK2_USER_STACK_PHYSICAL_ADDR
    push __TASK2_USER_STACK_SIZE
    push __DIR_PAGE_ATT_USER_RW
    push __PAGE_TABLE_ATT_USER_RW
    call __paginate
    times 7 pop eax
