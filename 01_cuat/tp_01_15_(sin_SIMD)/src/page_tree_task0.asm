...
;*************************************************************************************;
GLOBAL	page_memory_task0
page_memory_task0:
; Limpio el Directorio y las Tablas de paginación
EXTERN  __PAGE_DIRECTORY_ADDR_TASK0
EXTERN  __PAGE_TABLE_0x000_TASK0_ADDR
EXTERN  __PAGE_TABLE_0x001_TASK0_ADDR
EXTERN  __PAGE_TABLE_0x07F_TASK0_ADDR
EXTERN  __PAGE_TABLE_0x3FF_TASK0_ADDR
EXTERN  __PAGE_TABLES_SIZE
    mov edi, __PAGE_DIRECTORY_ADDR_TASK0
...
EXTERN  __INIT_PHYSICAL_ADDR
    push __PAGE_DIRECTORY_ADDR_TASK0
    push __PAGE_TABLE_0x3FF_TASK0_ADDR
...
EXTERN  __ISR_LEN
    push __PAGE_DIRECTORY_ADDR_TASK0
    push __PAGE_TABLE_0x000_TASK0_ADDR
...
EXTERN  __KERNEL_LEN
    push __PAGE_DIRECTORY_ADDR_TASK0
    push __PAGE_TABLE_0x001_TASK0_ADDR
...
EXTERN  __TASK0_TEXT_PHYSICAL_ADDR
EXTERN  __TASK0_TEXT_LEN
    push __PAGE_DIRECTORY_ADDR_TASK0
    push __PAGE_TABLE_0x001_TASK0_ADDR
    push __TASK0_TEXT_LINEAR_ADDR
    push __TASK0_TEXT_PHYSICAL_ADDR
...
EXTERN  __TASK0_BSS_LINEAR_ADDR
EXTERN  __TASK0_BSS_PHYSICAL_ADDR
EXTERN  __TASK0_BSS_LEN
    push __PAGE_DIRECTORY_ADDR_TASK0
    push __PAGE_TABLE_0x001_TASK0_ADDR
    push __TASK0_BSS_LINEAR_ADDR
    push __TASK0_BSS_PHYSICAL_ADDR
    push __TASK0_BSS_LEN
    push __DIR_PAGE_ATT_KERNEL_RW
    push __PAGE_TABLE_ATT_KERNEL_RW
    call __paginate
    times 7 pop eax
...
;Tamaño de la sección: 0x9 Bytes ==> 1 página
EXTERN  __TASK0_DATA_LINEAR_ADDR
EXTERN  __TASK0_DATA_PHYSICAL_ADDR
EXTERN  __TASK0_DATA_LEN
    push __PAGE_DIRECTORY_ADDR_TASK0
    push __PAGE_TABLE_0x001_TASK0_ADDR
    push __TASK0_DATA_LINEAR_ADDR
    push __TASK0_DATA_PHYSICAL_ADDR
    push __TASK0_DATA_LEN
    push __DIR_PAGE_ATT_KERNEL_RW
    push __PAGE_TABLE_ATT_KERNEL_RW
    call __paginate
    times 7 pop eax
...
EXTERN  __KERNEL_STACK_SIZE
    push __PAGE_DIRECTORY_ADDR_TASK0
    push __PAGE_TABLE_0x07F_TASK0_ADDR
...
;Paginación de TASK0_STACK
;Dirección física: 0x1FFF8000
...
EXTERN  __TASK0_KERNEL_STACK_LINEAR_ADDR
EXTERN  __TASK0_KERNEL_STACK_PHYSICAL_ADDR
EXTERN  __TASK0_KERNEL_STACK_SIZE
    push __PAGE_DIRECTORY_ADDR_TASK0
    push __PAGE_TABLE_0x001_TASK0_ADDR
    push __TASK0_KERNEL_STACK_LINEAR_ADDR
    push __TASK0_KERNEL_STACK_PHYSICAL_ADDR
    push __TASK0_KERNEL_STACK_SIZE
    push __DIR_PAGE_ATT_KERNEL_RW
    push __PAGE_TABLE_ATT_KERNEL_RW
    call __paginate
    times 7 pop eax
...
;Tamaño de la sección: 0x1000 Bytes ==> 1 página
EXTERN  __TASK0_USER_STACK_LINEAR_ADDR
EXTERN  __TASK0_USER_STACK_PHYSICAL_ADDR
EXTERN  __TASK0_USER_STACK_SIZE
    push __PAGE_DIRECTORY_ADDR_TASK0
    push __PAGE_TABLE_0x001_TASK0_ADDR
    push __TASK0_USER_STACK_LINEAR_ADDR
    push __TASK0_USER_STACK_PHYSICAL_ADDR
    push __TASK0_USER_STACK_SIZE
    push __DIR_PAGE_ATT_KERNEL_RW
    push __PAGE_TABLE_ATT_KERNEL_RW
    call __paginate
    times 7 pop eax
