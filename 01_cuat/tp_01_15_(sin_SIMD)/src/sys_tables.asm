...
EXTERN  ISR128_0x80_HANDLER

use32

GLOBAL 	cs_sel_ram
GLOBAL 	ds_sel_ram
GLOBAL 	cs_sel_ram_pl3
GLOBAL 	ds_sel_ram_pl3
GLOBAL 	gdt_ram
GLOBAL	img_gdtr_ram
GLOBAL  TSS_sel
...
section .sys_tables
  ...
  ds_sel_ram_pl3    equ $-gdt_ram+RPL3
            db 0xFF, 0xFF, 0, 0, 0, 0xF2, 0xCF, 0
  cs_sel_ram_pl3    equ $-gdt_ram+RPL3
  ...
  idt:
    ...
    EX32_ISR0_0x20	equ $-idt        ;PIT interrupt
    ...
    EX33_ISR1_0x21	equ $-idt        ;Keyboard interrupt
    ...
    EX34_ISR2_0x22	equ $-idt        ;Cascade interrupt
    ...
    EX_48_127   equ $-idt    ; Reserved
      times 80 dq 0x0

    EX_128_syscall  equ $-idt   ;System call
      dw ISR128_0x80_HANDLER    ;Offset del handler
      dw  cs_sel_ram            ;Selector con DPL0
      db  0x0                   ;Reserved
      db  0xEF                  ;DPL3, exception gate
      dw  0x0                   ;Offset:parte alta
