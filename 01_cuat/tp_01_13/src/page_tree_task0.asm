...
EXTERN  __TASK0_STACK_LINEAR_ADDR
EXTERN  __TASK0_STACK_PHYSICAL_ADDR
EXTERN  __TASK0_STACK_SIZE
    push __PAGE_DIRECTORY_ADDR_TASK0
    push __PAGE_TABLE_0x001_TASK0_ADDR
    push __TASK0_STACK_LINEAR_ADDR
    push __TASK0_STACK_PHYSICAL_ADDR
    push __TASK0_STACK_SIZE
    push __DIR_PAGE_ATT_USER_RW
    push __PAGE_TABLE_ATT_USER_RW
    call __paginate
    times 7 pop eax
