...
EXTERN  __TASK2_STACK_LINEAR_ADDR
EXTERN  __TASK2_STACK_PHYSICAL_ADDR
EXTERN  __TASK2_STACK_SIZE
    push __PAGE_DIRECTORY_ADDR_TASK2
    push __PAGE_TABLE_0x001_TASK2_ADDR
    push __TASK2_STACK_LINEAR_ADDR
    push __TASK2_STACK_PHYSICAL_ADDR
