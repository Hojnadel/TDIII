...
EXTERN new_number_flag_T1
EXTERN new_number_flag_T2
...
analysis_buffer_to_digit_table:
	...
	mov byte [new_number_flag_T1], 1 					;prendo el flag que indica que se ingreso un nuevo numero
	mov byte [new_number_flag_T2], 1 					;prendo el flag que indica que se ingreso un nuevo numero
	.exit:
	ret
